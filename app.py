...
diabetes_df = pd.read_csv('D:\Projects\diabetes-predictor\Diabetes-Disease-Prediction-Model\diabetes.csv')
...
def app():
    ...
    img = Image.open(r"D:\Projects\diabetes-predictor\Diabetes-Disease-Prediction-Model\img.jpeg")
